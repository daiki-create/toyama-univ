...
# ===========================================================================================================================================
# 使用データファイルの取得
files = glob.glob("../datasets/tsunami/m7/*")
        ...
        if j == 1:
            while True:
                ...
                if data3[4] != 'null':
                    ...
                    st_lat = math.radians(st_lat)
                    st_lon = math.radians(st_lon)
                    
                    lat_difference = lat - st_lat # 緯度差
                    lon_difference = lon - st_lon # 経度差
                    lat_average = (lat + st_lat) / 2 # 平均緯度
                    ...
                    print(dis)
                    if 200 <= dis <= 230:
                        data3_list = [dis ,seismic_dis1 ,seismic_dis2 ,seismic_dis3 ,tsunami_h]
                        tsunami_data.append(data3_list)
                        f2 = open("../datasets/tsunami/6/data","a")
                        f2.write("\n"+str(dis)+","+str(seismic_dis3)+","+str(tsunami_h))
