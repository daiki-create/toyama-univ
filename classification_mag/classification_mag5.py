...
index = np.arange(len(lat_lon_input))
index_train = index[index < len(index)*4/5-1]
index_test = index[index >= len(index)*4/5-1]

input_train = lat_lon_input[index_train, : ]
input_test = lat_lon_input[index_test, : ]
correct_train = lat_lon_correct[index_train, : ]
correct_test = lat_lon_correct[index_test, : ]
